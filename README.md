...
* **Automated Manifest Updates:** Receives webhooks/repository dispatches from the upstream application repo `sample-http` to automatically update the container image tag in the Helm `values.yaml`.
